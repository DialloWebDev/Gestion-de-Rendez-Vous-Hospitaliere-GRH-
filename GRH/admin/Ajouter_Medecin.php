<?php
    ...
    if(!empty($_POST)){
        ...
        if (isset($_POST['enregistrer'])){
            $id_Medecin = trim($id_Medecin); // On récupère le matricule
            ...
            $specialite = (trim($specialite)); // on récupère le specialite
            ...
            //  Vérification du Specialite
            if(empty($specialite)){
                $valid = false;
                $er_specialite = ("Le nom d'utilisateur ne peut pas être vide");
            } 
          ...
          <legend>Nouveau Medecin</legend>
            <form method="POST">
                ...
                <div> 
                    ...
                    <label for="MDP"> specialite :</label>
                    <?php
                        // S'il y a une erreur sur l'specialite alors on affiche
                        if (isset($er_specialite)){
                        ?>
                        <div><?= $er_specialite ?></div>
                        <?php   
                        }
                    ?>
                    <input type="text" name="specialite" class="saisi" id="specialite" value="<?php if(isset($specialite)){ echo $specialite; }?>" required>
                </div>
